...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> pWriter) {
        oreSmelting(pWriter, VISCOROK_SMELTABLES, RecipeCategory.MISC, ModItems.VISCOROK_INGOT.get(), 0.25f, 200, "sapphire");
        oreBlasting(pWriter, VISCOROK_SMELTABLES, RecipeCategory.MISC, ModItems.VISCOROK_INGOT.get(), 0.25f, 100, "sapphire");
