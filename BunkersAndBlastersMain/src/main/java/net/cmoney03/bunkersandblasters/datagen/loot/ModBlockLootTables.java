package net.cmoney03.bunkersandblasters.datagen.loot;
...
public class ModBlockLootTables extends BlockLootSubProvider {
    ...
    protected void generate() {
        this.dropSelf(ModBlocks.VISCOROK_BLOCK.get());
        this.dropSelf(ModBlocks.PLASTEEL_BLOCK.get());
        ...
        this.add(ModBlocks.BRACHITE_ORE.get(),
                block -> createCopperLikeOreDrops(ModBlocks.BRACHITE_ORE.get(), ModItems.BRACHITE_INGOT.get()));
